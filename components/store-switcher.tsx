  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-[200px] p-0">
        <Command>
          <div className="ư-full px-2 py-1 flex items-center border rounded-md border-gray-100">
          ...
          <CommandList>
            <CommandGroup>
              <CreateNewStoreItem onClick={()=> {setOpen(false)
                storeModal.onOpen()
              }}/>
            </CommandGroup>
          </CommandList>
